...
namespace DataED.PresentationLayer.Commands {
    public class RSAEncryptWithExistKeyAndSaveToFileCommand : CryptoCommand {
        public RSAEncryptWithExistKeyAndSaveToFileCommand(string name, ICryptoService cryptoService) : base(name, cryptoService) {
        }
